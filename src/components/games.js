...
const games = [
  ...
  // Set B — παιχνίδια 17-31, προστίθενται καθώς φτάνει το υλικό.
  // Κάθε νέα εγγραφή χρειάζεται και αντίστοιχο component στο GameScreen (gameComponents).
  // Οι ασκήσεις του Σετ Β δεν έχουν ηχητικά ούτε βίντεο επεξήγησης.
