...
import { game25Items } from "../Data/Game25Data";
import useAudio from "../../hooks/useAudio";
import bravoAudio from "../../assets/sounds/general/bravo.mp3";
import practiceEnd from "../../assets/sounds/general/end-of-practice.mp3";

const Game25 = ({ gameId, schoolId, studentId, classId }) => {
  ...
  const items = useMemo(() => game25Items, []);
  const currentItem = items[currentIndex];
  const taskTitle = currentItem.task === "synonym" ? "Βρίσκω το ΣΥΝΩΝΥΜΟ της λέξης" : "Βρίσκω το ΑΝΤΩΝΥΜΟ της λέξης";
    ...
    <Container fluid className="game-container">
      ...
      <Row className="game-row-centered">
        <Col md={12} lg={10}>
          ...
          <Card className="main-card">
            <Card.Header className="text-center" style={{ backgroundColor: "#2F4F4F", color: "white" }}>
              <h4 className="mb-0 game-title-header">{taskTitle}</h4>
            </Card.Header>
            <Card.Body>
